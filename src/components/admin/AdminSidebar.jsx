...
import { LayoutDashboard, Wrench, Cog, History, Users, Settings } from 'lucide-react'
...
const AdminSidebar = () => {
  ...
  const menuItems = [
    ...
    { to: '/admin/installation', label: 'Installation', icon: <Cog size={20} /> },
    { to: '/admin/maintenance', label: 'Maintenance', icon: <Wrench size={20} /> },
    { to: '/admin/service-history', label: 'Service History', icon: <History size={20} /> },
    { to: '/admin/technicians', label: 'Technicians', icon: <Users size={20} /> },
